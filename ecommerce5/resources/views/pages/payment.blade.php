                           ...
                           <div class="form-group">
                                <ul class="logos_list " >
                                            ...
                                            <li><input type="radio" name="payment" value="paypal"> <img src="{{ asset('public/frontend/images/paypal.png') }}" style="width: 100px;"></li>
                                             <li><input type="radio" name="payment" value="ideal"> <img src="{{ asset('public/frontend/images/blogo.png') }}" style="width: 100px; height: 80px;"></li>
                                 </ul>
                            </div><br>
                            <div class="contact_form_button">
                               ...
                               <div class="btn btn-info">
                                ...
                                <label for="exampleInputEmail1">01823760352 </label>
                                <input type="text" class="btn btn-info" name="0182360352"  aria-describedby="emailHelp" placeholder="Call "  required="0182360352">
                                   </div>
